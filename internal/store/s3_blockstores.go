...
//go:generate mockgen -destination=../mocks/mock_backup_s3_blockstores.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/v2/internal/store S3BlockstoresLister,S3BlockstoresDeleter,S3BlockstoresCreator,S3BlockstoresUpdater,S3BlockstoresDescriber
