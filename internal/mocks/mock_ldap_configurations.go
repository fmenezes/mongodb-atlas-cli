...
// Source: github.com/fmenezes/mongodb-atlas-cli/internal/store (interfaces: LDAPConfigurationVerifier,LDAPConfigurationDescriber,LDAPConfigurationSaver,LDAPConfigurationDeleter,LDAPConfigurationGetter)
