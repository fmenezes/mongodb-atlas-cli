...
//go:generate mockgen -destination=../../mocks/atlas/mock_serverless_private_endpoints.go -package=atlas github.com/fmenezes/mongodb-atlas-cli/internal/store/atlas ServerlessPrivateEndpointsLister
