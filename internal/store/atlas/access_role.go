...
//go:generate mockgen -destination=../../mocks/atlas/mock_access_role.go -package=atlas github.com/fmenezes/mongodb-atlas-cli/v2/internal/store/atlas CloudProviderAccessRoleLister
