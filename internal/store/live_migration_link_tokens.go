...
//go:generate mockgen -destination=../mocks/mock_live_migration_link_tokens.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/atlascli/internal/store LinkTokenCreator,LinkTokenDeleter
