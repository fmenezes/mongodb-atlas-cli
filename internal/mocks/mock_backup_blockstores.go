...
// Source: github.com/fmenezes/mongodb-atlas-cli/internal/store (interfaces: BlockstoresLister,BlockstoresDescriber,BlockstoresCreator,BlockstoresUpdater,BlockstoresDeleter)
