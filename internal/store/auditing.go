...
//go:generate mockgen -destination=../mocks/mock_auditing.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/v2/internal/store AuditingDescriber,AuditingUpdater
