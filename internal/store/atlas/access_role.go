...
//go:generate mockgen -destination=../../mocks/atlas/mock_access_role.go -package=atlas github.com/fmenezes/mongodb-atlas-cli/internal/store/atlas CloudProviderAccessRoleLister
