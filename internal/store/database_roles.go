...
//go:generate mockgen -destination=../mocks/mock_database_roles.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/internal/store DatabaseRoleLister,DatabaseRoleCreator,DatabaseRoleDeleter,DatabaseRoleUpdater,DatabaseRoleDescriber
