...
//go:generate mockgen -destination=../mocks/mock_data_lake_pipelines.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/atlascli/internal/store PipelinesLister,PipelinesDescriber,PipelinesCreator,PipelinesUpdater,PipelinesDeleter,PipelineAvailableSnapshotsLister,PipelineAvailableSchedulesLister,PipelinesTriggerer,PipelinesPauser,PipelinesResumer
