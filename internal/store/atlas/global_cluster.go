...
//go:generate mockgen -destination=../../mocks/atlas/mock_global_cluster.go -package=atlas github.com/fmenezes/mongodb-atlas-cli/internal/store/atlas GlobalClusterDescriber
