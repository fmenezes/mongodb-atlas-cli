...
//go:generate mockgen -destination=../mocks/mock_live_migrations.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/v2/internal/store LiveMigrationCreator,LiveMigrationDescriber
