...
//go:generate mockgen -destination=../mocks/mock_database_users.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/atlascli/internal/store DatabaseUserLister,DatabaseUserCreator,DatabaseUserDeleter,DatabaseUserUpdater,DatabaseUserDescriber,DBUserCertificateLister,DBUserCertificateCreator
