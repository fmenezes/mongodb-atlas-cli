...
//go:generate mockgen -destination=../../mocks/atlas/mock_service_version.go -package=atlas github.com/fmenezes/mongodb-atlas-cli/internal/store/atlas ServiceVersionDescriber
