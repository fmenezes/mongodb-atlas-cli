...
//go:generate mockgen -destination=../mocks/mock_live_migrations.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/internal/store LiveMigrationCreator,LiveMigrationDescriber
