...
//go:generate mockgen -destination=../mocks/mock_serverless_private_endpoints.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/atlascli/internal/store ServerlessPrivateEndpointsLister
