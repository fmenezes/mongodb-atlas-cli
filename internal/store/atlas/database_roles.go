...
//go:generate mockgen -destination=../../mocks/atlas/mock_database_roles.go -package=atlas github.com/fmenezes/mongodb-atlas-cli/internal/store/atlas DatabaseRoleLister
