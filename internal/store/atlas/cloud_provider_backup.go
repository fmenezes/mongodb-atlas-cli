...
//go:generate mockgen -destination=../../mocks/atlas/mock_cloud_provider_backup.go -package=atlas github.com/fmenezes/mongodb-atlas-cli/internal/store/atlas ScheduleDescriber
