...
//go:generate mockgen -destination=../../mocks/atlas/mock_integrations.go -package=atlas github.com/fmenezes/mongodb-atlas-cli/internal/store/atlas IntegrationLister
