...
//go:generate mockgen -destination=../../mocks/atlas/mock_project_ip_access_lists.go -package=atlas github.com/fmenezes/mongodb-atlas-cli/internal/store/atlas ProjectIPAccessListLister
