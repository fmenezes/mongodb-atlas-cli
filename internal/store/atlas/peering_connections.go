...
//go:generate mockgen -destination=../../mocks/atlas/mock_peering_connections.go -package=atlas github.com/fmenezes/mongodb-atlas-cli/internal/store/atlas PeeringConnectionLister
