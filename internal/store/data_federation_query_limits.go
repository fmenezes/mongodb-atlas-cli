...
//go:generate mockgen -destination=../mocks/mock_data_federation_query_limits.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/atlascli/internal/store DataFederationQueryLimitLister,DataFederationQueryLimitDescriber,DataFederationQueryLimitCreator,DataFederationQueryLimitDeleter
