...
//go:generate mockgen -destination=../../mocks/atlas/mock_project_settings.go -package=atlas github.com/fmenezes/mongodb-atlas-cli/v2/internal/store/atlas ProjectSettingsDescriber
