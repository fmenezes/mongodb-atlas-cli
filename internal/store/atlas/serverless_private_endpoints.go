...
//go:generate mockgen -destination=../../mocks/atlas/mock_serverless_private_endpoints.go -package=atlas github.com/fmenezes/mongodb-atlas-cli/v2/internal/store/atlas ServerlessPrivateEndpointsLister
