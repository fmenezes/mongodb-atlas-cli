...
//go:generate mockgen -destination=../mocks/mock_monitoring.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/internal/store MonitoringStarter,MonitoringStopper
