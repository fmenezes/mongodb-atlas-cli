...
//go:generate mockgen -destination=../mocks/mock_mongodb_client.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/atlascli/internal/mongodbclient MongoDBClient,Database,SearchIndex
