...
//go:generate mockgen -destination=../mocks/mock_serverless_instances.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/internal/store ServerlessInstanceLister,ServerlessInstanceDescriber,ServerlessInstanceDeleter,ServerlessInstanceCreator,ServerlessInstanceUpdater
