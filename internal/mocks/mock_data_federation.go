...
// Source: github.com/fmenezes/mongodb-atlas-cli/atlascli/internal/store (interfaces: DataFederationLister,DataFederationDescriber,DataFederationStore,DataFederationCreator,DataFederationUpdater,DataFederationDeleter,DataFederationLogDownloader)
