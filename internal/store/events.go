...
//go:generate mockgen -destination=../mocks/mock_events.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/atlascli/internal/store OrganizationEventLister,ProjectEventLister,EventLister
