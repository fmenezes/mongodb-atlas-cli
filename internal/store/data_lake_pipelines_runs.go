...
//go:generate mockgen -destination=../mocks/mock_data_lake_pipelines_runs.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/atlascli/internal/store PipelineRunsLister,PipelineRunsDescriber
