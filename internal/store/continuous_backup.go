...
//go:generate mockgen -destination=../mocks/mock_continuous_backup.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/v2/internal/store CheckpointsLister,ContinuousJobLister,ContinuousJobCreator,ContinuousSnapshotsLister
