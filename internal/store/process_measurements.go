...
//go:generate mockgen -destination=../mocks/mock_process_measurements.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/internal/store ProcessMeasurementLister
