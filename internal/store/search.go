...
//go:generate mockgen -destination=../mocks/mock_search.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/v2/internal/store SearchIndexLister,SearchIndexCreator,SearchIndexDescriber,SearchIndexUpdater,SearchIndexDeleter
