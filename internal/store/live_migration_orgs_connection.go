...
//go:generate mockgen -destination=../mocks/mock_live_migration_orgs_connection.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/v2/internal/store OrganizationsConnector,OrganizationsDescriber
