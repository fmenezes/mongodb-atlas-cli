...
//go:generate mockgen -destination=../mocks/mock_users.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/v2/internal/store UserCreator,UserDescriber,UserDeleter,UserLister,TeamUserLister
