...
//go:generate mockgen -destination=../mocks/mock_automation.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/v2/internal/store AutomationGetter,AutomationUpdater,AutomationStatusGetter,AutomationPatcher,CloudManagerClustersLister,CloudManagerClustersDescriber,CloudManagerClustersDeleter
