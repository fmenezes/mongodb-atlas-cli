...
// Source: github.com/fmenezes/mongodb-atlas-cli/v2/internal/store/atlas (interfaces: OperatorGenericStore)
...
func (mr *MockOperatorGenericStoreMockRecorder) DataFederationList(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DataFederationList", reflect.TypeOf((*MockOperatorGenericStore)(nil).DataFederationList), arg0, arg1)
}
...
func (m *MockOperatorGenericStore) PeeringConnections(arg0 string, arg1 *mongodbatlas.ContainersListOptions) ([]admin.BaseNetworkPeeringConnectionSettings, error) {
	m.ctrl.T.Helper()
...
func (m *MockOperatorGenericStore) Projects(arg0 *mongodbatlas.ListOptions) (*admin.PaginatedAtlasGroup, error) {
	m.ctrl.T.Helper()
