...
// Source: github.com/fmenezes/mongodb-atlas-cli/v2/internal/store/atlas (interfaces: OperatorProjectStore)
...
func (m *MockOperatorProjectStore) PeeringConnections(arg0 string, arg1 *mongodbatlas.ContainersListOptions) ([]admin.BaseNetworkPeeringConnectionSettings, error) {
	m.ctrl.T.Helper()
...
func (m *MockOperatorProjectStore) Projects(arg0 *mongodbatlas.ListOptions) (*admin.PaginatedAtlasGroup, error) {
	m.ctrl.T.Helper()
