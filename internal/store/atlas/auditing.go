...
//go:generate mockgen -destination=../../mocks/atlas/mock_auditing.go -package=atlas github.com/fmenezes/mongodb-atlas-cli/v2/internal/store/atlas AuditingDescriber
