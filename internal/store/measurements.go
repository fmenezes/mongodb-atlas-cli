...
//go:generate mockgen -destination=../mocks/mock_measurements.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/internal/store HostMeasurementLister,HostDiskMeasurementsLister,HostDatabaseMeasurementsLister
