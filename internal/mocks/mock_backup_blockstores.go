...
// Source: github.com/fmenezes/mongodb-atlas-cli/v2/internal/store (interfaces: BlockstoresLister,BlockstoresDescriber,BlockstoresCreator,BlockstoresUpdater,BlockstoresDeleter)
