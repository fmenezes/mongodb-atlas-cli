...
//go:generate mockgen -destination=../../mocks/atlas/mock_maintenance.go -package=atlas github.com/fmenezes/mongodb-atlas-cli/internal/store/atlas MaintenanceWindowDescriber
