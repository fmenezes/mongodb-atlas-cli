...
//go:generate mockgen -destination=../mocks/mock_search.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/internal/store SearchIndexLister,SearchIndexCreator,SearchIndexDescriber,SearchIndexUpdater,SearchIndexDeleter
