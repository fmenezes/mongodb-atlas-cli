...
//go:generate mockgen -destination=../mocks/mock_measurements.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/v2/internal/store HostMeasurementLister,HostDiskMeasurementsLister,HostDatabaseMeasurementsLister
