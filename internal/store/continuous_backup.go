...
//go:generate mockgen -destination=../mocks/mock_continuous_backup.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/internal/store CheckpointsLister,ContinuousJobLister,ContinuousJobCreator,ContinuousSnapshotsLister
