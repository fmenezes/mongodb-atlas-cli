...
//go:generate mockgen -destination=../mocks/mock_alerts.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/v2/internal/store AlertDescriber,AlertLister,AlertAcknowledger
