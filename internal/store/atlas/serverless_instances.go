...
//go:generate mockgen -destination=../../mocks/atlas/mock_serverless_instances.go -package=atlas github.com/fmenezes/mongodb-atlas-cli/internal/store/atlas ServerlessInstanceLister,ServerlessInstanceDescriber
