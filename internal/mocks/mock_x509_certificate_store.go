...
// Source: github.com/fmenezes/mongodb-atlas-cli/v2/internal/store (interfaces: X509CertificateConfDescriber,X509CertificateConfSaver,X509CertificateConfDisabler)
