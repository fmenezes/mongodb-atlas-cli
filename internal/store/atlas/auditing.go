...
//go:generate mockgen -destination=../../mocks/atlas/mock_auditing.go -package=atlas github.com/fmenezes/mongodb-atlas-cli/internal/store/atlas AuditingDescriber
