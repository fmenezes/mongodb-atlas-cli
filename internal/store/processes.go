...
//go:generate mockgen -destination=../mocks/mock_processes.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/v2/internal/store ProcessLister,ProcessDescriber
