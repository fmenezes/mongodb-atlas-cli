...
//go:generate mockgen -destination=../../mocks/atlas/mock_events.go -package=atlas github.com/fmenezes/mongodb-atlas-cli/v2/internal/store/atlas OrganizationEventLister,ProjectEventLister,EventLister
