...
//go:generate mockgen -destination=../mocks/mock_backup_sync.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/v2/internal/store SyncsLister,SyncsDescriber,SyncsCreator,SyncsUpdater,SyncsDeleter
