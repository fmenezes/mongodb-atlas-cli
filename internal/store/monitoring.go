...
//go:generate mockgen -destination=../mocks/mock_monitoring.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/v2/internal/store MonitoringStarter,MonitoringStopper
