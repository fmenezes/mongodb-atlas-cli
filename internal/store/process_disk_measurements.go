...
//go:generate mockgen  -destination=../mocks/mock_process_disk_measurements.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/v2/internal/store ProcessDiskMeasurementsLister,ProcessDatabaseMeasurementsLister
