...
import (
	...
	"github.com/fmenezes/mongodb-atlas-cli/v2/internal/cli/opsmanager/admin/backup"
...
var createTemplate = "S3 blockstore configuration '{{.ID}}' created.\n"
...
func (opts *CreateOpts) Run() error {
	r, err := opts.store.CreateS3Blockstores(opts.newS3Blockstore())
	if err != nil {
		return err
	}
	return opts.Print(r)
