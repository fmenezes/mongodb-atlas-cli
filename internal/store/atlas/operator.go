...
//go:generate mockgen -destination=../../mocks/atlas/mock_atlas_operator_cluster_store.go -package=atlas github.com/fmenezes/mongodb-atlas-cli/v2/internal/store/atlas OperatorClusterStore
//go:generate mockgen -destination=../../mocks/atlas/mock_atlas_operator_project_store.go -package=atlas github.com/fmenezes/mongodb-atlas-cli/v2/internal/store/atlas OperatorProjectStore
//go:generate mockgen -destination=../../mocks/atlas/mock_atlas_operator_db_users_store.go -package=atlas github.com/fmenezes/mongodb-atlas-cli/v2/internal/store/atlas OperatorDBUsersStore
//go:generate mockgen -destination=../../mocks/atlas/mock_atlas_operator_org_store.go -package=atlas github.com/fmenezes/mongodb-atlas-cli/v2/internal/store/atlas OperatorOrgStore
//go:generate mockgen -destination=../../mocks/atlas/mock_atlas_generic_store.go -package=atlas github.com/fmenezes/mongodb-atlas-cli/v2/internal/store/atlas OperatorGenericStore
