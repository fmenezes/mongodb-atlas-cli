...
//go:generate mockgen -destination=../mocks/mock_feature_control_policy.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/v2/internal/store FeatureControlPoliciesLister,FeatureControlPoliciesUpdater
