...
//go:generate mockgen -destination=../mocks/mock_backup_snapshot_schedule.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/v2/internal/store SnapshotScheduleDescriber,SnapshotScheduleUpdater
