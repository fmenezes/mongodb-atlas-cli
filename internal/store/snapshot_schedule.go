...
//go:generate mockgen -destination=../mocks/mock_backup_snapshot_schedule.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/internal/store SnapshotScheduleDescriber,SnapshotScheduleUpdater
