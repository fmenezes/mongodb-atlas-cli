...
//go:generate mockgen -destination=../../mocks/atlas/mock_cloud_provider_backup.go -package=atlas github.com/fmenezes/mongodb-atlas-cli/v2/internal/store/atlas ScheduleDescriber
