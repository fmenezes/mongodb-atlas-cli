...
//go:generate mockgen -destination=../../mocks/atlas/mock_database_users.go -package=atlas github.com/fmenezes/mongodb-atlas-cli/internal/store/atlas DatabaseUserLister
