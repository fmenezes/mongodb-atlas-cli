...
//go:generate mockgen -destination=../../mocks/atlas/mock_database_roles.go -package=atlas github.com/fmenezes/mongodb-atlas-cli/v2/internal/store/atlas DatabaseRoleLister
