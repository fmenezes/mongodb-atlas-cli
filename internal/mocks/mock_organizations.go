...
// Source: github.com/fmenezes/mongodb-atlas-cli/atlascli/internal/store (interfaces: OrganizationLister,OrganizationDeleter,OrganizationDescriber,OrganizationCreator)
