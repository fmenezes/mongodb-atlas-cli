...
//go:generate mockgen -destination=../mocks/mock_users.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/atlascli/internal/store UserCreator,UserDescriber,UserLister,TeamUserLister
