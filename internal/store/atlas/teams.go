...
//go:generate mockgen -destination=../../mocks/atlas/mock_teams.go -package=atlas github.com/fmenezes/mongodb-atlas-cli/internal/store/atlas TeamLister,TeamDescriber,TeamCreator,TeamRenamer,TeamDeleter,TeamAdder,TeamUserRemover,TeamRolesUpdater
