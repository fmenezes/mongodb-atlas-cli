...
//go:generate mockgen -destination=../../mocks/atlas/mock_project_settings.go -package=atlas github.com/fmenezes/mongodb-atlas-cli/internal/store/atlas ProjectSettingsDescriber
