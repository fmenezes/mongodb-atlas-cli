...
//go:generate mockgen -destination=../mocks/mock_feature_control_policy.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/internal/store FeatureControlPoliciesLister,FeatureControlPoliciesUpdater
