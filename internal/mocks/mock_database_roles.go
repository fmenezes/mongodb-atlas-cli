...
// Source: github.com/fmenezes/mongodb-atlas-cli/v2/internal/store (interfaces: DatabaseRoleLister,DatabaseRoleCreator,DatabaseRoleDeleter,DatabaseRoleUpdater,DatabaseRoleDescriber)
