...
//go:generate mockgen -destination=../mocks/mock_auditing.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/internal/store AuditingDescriber,AuditingUpdater
