...
//go:generate mockgen -destination=../mocks/mock_release_version.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/v2/internal/version ReleaseVersionDescriber
