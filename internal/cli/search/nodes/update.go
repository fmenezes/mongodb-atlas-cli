...
var updateTemplate = "Started updating search nodes.\n"
var updateWatchTemplate = "Search nodes are updated.\n"
...
func (opts *UpdateOpts) Run() error {
	...
	r, err := opts.store.UpdateSearchNodes(opts.ConfigProjectID(), opts.clusterName, spec)
	if err != nil {
		return err
	}
...
func UpdateBuilder() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "update",
		Short: "Update a search node for a cluster.",
