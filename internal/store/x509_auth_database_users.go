...
//go:generate mockgen -destination=../mocks/mock_x509_certificate_store.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/v2/internal/store X509CertificateConfDescriber,X509CertificateConfSaver,X509CertificateConfDisabler
