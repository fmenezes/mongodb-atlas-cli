...
// Source: github.com/fmenezes/mongodb-atlas-cli/atlascli/internal/store (interfaces: SearchNodesLister,SearchNodesCreator,SearchNodesUpdater,SearchNodesDeleter)
