...
//go:generate mockgen -destination=../../mocks/atlas/mock_encryption_at_rest.go -package=atlas github.com/fmenezes/mongodb-atlas-cli/v2/internal/store/atlas EncryptionAtRestDescriber
