...
//go:generate mockgen -destination=../mocks/mock_process_disks.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/atlascli/internal/store ProcessDisksLister
