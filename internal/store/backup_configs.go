...
//go:generate mockgen -destination=../mocks/mock_backup_config.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/internal/store BackupConfigGetter,BackupConfigLister,BackupConfigUpdater
