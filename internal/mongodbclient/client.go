...
//go:generate mockgen -destination=../mocks/mock_mongodb_client.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/v2/internal/mongodbclient MongoDBClient,Database,SearchIndex
