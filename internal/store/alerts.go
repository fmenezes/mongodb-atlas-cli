...
//go:generate mockgen -destination=../mocks/mock_alerts.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/internal/store AlertDescriber,AlertLister,AlertAcknowledger
