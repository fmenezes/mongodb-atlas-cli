...
// Source: github.com/fmenezes/mongodb-atlas-cli/atlascli/internal/store (interfaces: AccessLogsListerByClusterName,AccessLogsListerByHostname,AccessLogsLister)
