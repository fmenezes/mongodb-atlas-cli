...
//go:generate mockgen -destination=../mocks/mock_global_api_keys_access_list.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/internal/store GlobalAPIKeyWhitelistLister,GlobalAPIKeyWhitelistDescriber,GlobalAPIKeyWhitelistCreator,GlobalAPIKeyWhitelistDeleter
