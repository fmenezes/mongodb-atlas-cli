...
//go:generate mockgen -destination=../../mocks/atlas/mock_private_endpoints.go -package=atlas github.com/fmenezes/mongodb-atlas-cli/internal/store/atlas PrivateEndpointLister
