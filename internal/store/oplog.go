...
//go:generate mockgen -destination=../mocks/mock_backup_oplogs.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/internal/store OplogsLister,OplogsDescriber,OplogsCreator,OplogsUpdater,OplogsDeleter
