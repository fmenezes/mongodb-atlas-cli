...
// Source: github.com/fmenezes/mongodb-atlas-cli/v2/internal/store (interfaces: OrganizationLister,OrganizationCreator,OrganizationDeleter,OrganizationDescriber,AtlasOrganizationCreator)
...
type MockAtlasOrganizationCreator struct {
	ctrl     *gomock.Controller
	recorder *MockAtlasOrganizationCreatorMockRecorder
}
...
type MockAtlasOrganizationCreatorMockRecorder struct {
	mock *MockAtlasOrganizationCreator
}
...
func NewMockAtlasOrganizationCreator(ctrl *gomock.Controller) *MockAtlasOrganizationCreator {
	mock := &MockAtlasOrganizationCreator{ctrl: ctrl}
	mock.recorder = &MockAtlasOrganizationCreatorMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockAtlasOrganizationCreator) EXPECT() *MockAtlasOrganizationCreatorMockRecorder {
	return m.recorder
}

// CreateAtlasOrganization mocks base method.
func (m *MockAtlasOrganizationCreator) CreateAtlasOrganization(arg0 *mongodbatlas.CreateOrganizationRequest) (*mongodbatlas.CreateOrganizationResponse, error) {
	m.ctrl.T.Helper()
...
func (mr *MockAtlasOrganizationCreatorMockRecorder) CreateAtlasOrganization(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateAtlasOrganization", reflect.TypeOf((*MockAtlasOrganizationCreator)(nil).CreateAtlasOrganization), arg0)
}
