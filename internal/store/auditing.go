...
//go:generate mockgen -destination=../mocks/mock_auditing.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/atlascli/internal/store AuditingDescriber,AuditingUpdater
