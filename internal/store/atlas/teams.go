...
//go:generate mockgen -destination=../../mocks/atlas/mock_teams.go -package=atlas github.com/fmenezes/mongodb-atlas-cli/v2/internal/store/atlas TeamLister,TeamDescriber,TeamCreator,TeamRenamer,TeamDeleter,TeamAdder,TeamUserRemover,TeamRolesUpdater
