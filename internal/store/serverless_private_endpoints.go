...
//go:generate mockgen -destination=../mocks/mock_serverless_private_endpoints.go -package=mocks github.com/fmenezes/mongodb-atlas-cli/v2/internal/store ServerlessPrivateEndpointsLister
